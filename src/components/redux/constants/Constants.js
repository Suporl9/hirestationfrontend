...
//get the stripe key
export const GET_STRIPE_API_KEY_REQUEST = "GET_STRIPE_API_KEY_REQUEST";
export const GET_STRIPE_API_KEY_SUCCESS = "GET_STRIPE_API_KEY_SUCCESS";
export const GET_STRIPE_API_KEY_ERROR = "GET_STRIPE_API_KEY_ERROR";
export const GET_STRIPE_API_KEY_CLEAR_ERROR = "GET_STRIPE_API_KEY_CLEAR_ERROR";
